    ...
    <div style={{ minHeight: "100vh", background: "#07070f", color: "#fff" }}>
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ flex: 1, overflowY: "auto", padding: "4px 8px" }} className="custom-scroll">
              {isLoading ? (
                ...
                <div style={{ padding: 20, textAlign: "center" }}>
                  <span style={{ color: "rgba(255,255,255,0.15)", fontFamily: "monospace", fontSize: 11 }}>No tokens found</span>
                </div>
            ...
            <div style={{
              padding: "8px 12px",
              borderTop: "1px solid rgba(153,69,255,0.08)",
              display: "flex", justifyContent: "space-between", alignItems: "center",
            }}>
              <span style={{ color: "rgba(153,69,255,0.4)", fontFamily: "monospace", fontSize: 9, letterSpacing: "0.1em" }}>
                {total} TOKENS
              </span>
              <Link href="/create" style={{
                color: "#14F195", fontFamily: "monospace", fontSize: 9,
          ...
          {/* ══ CENTER: CHART + TRADES ══ */}
          <div style={{ display: "flex", flexDirection: "column", overflow: "hidden", borderRight: "1px solid rgba(153,69,255,0.1)" }}>
            ...
            {selectedToken ? (
              <>
                ...
                <div style={{
                  ...
                  <div style={{ display: "flex", gap: 20, marginLeft: 8, flexWrap: "wrap" }}>
                    {[
                      { label: "PRICE", value: priceText ? `${priceText} ${selectedToken.symbol}/SOL` : "—" },
                      { label: "CURVE", value: isLoadingCurve ? "···" : `${fillPercent.toFixed(2)}%` },
                    ].map(s => (
                      <div key={s.label}>
                ...
                {/* Chart area */}
                <div style={{ flex: 1, overflow: "hidden", position: "relative", minHeight: 280 }}>
                  <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{ fontSize: 28, filter: "drop-shadow(0 0 12px rgba(153,69,255,0.5))", opacity: 0.4 }}>◈</div>
                    <p style={{ color: "rgba(153,69,255,0.35)", fontFamily: "monospace", fontSize: 10, letterSpacing: "0.12em" }}>CHART_COMING_SOON</p>
                  </div>
                </div>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <span style={{ color: "rgba(153,69,255,0.6)", fontFamily: "monospace", fontSize: 9, letterSpacing: "0.14em" }}>RECENT ACTIVITY</span>
                  </div>
                  {/* Table header */}
                  <div style={{
                    display: "grid", gridTemplateColumns: "60px 1fr 1fr 80px 120px",
                    padding: "6px 16px",
              ...
              <div style={{
                ...
                <div style={{ fontSize: 48, filter: "drop-shadow(0 0 20px rgba(153,69,255,0.3))", opacity: 0.3 }}>◈</div>
