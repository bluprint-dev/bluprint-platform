        ...
        headers: [
          {
            ...
            value: `
              ...
              connect-src 'self' https://*.solana.com https://*.alchemy.com https://*.pinata.cloud https://*.upstash.io https://*.chatbase.co wss://*.solana.com wss://*.alchemy.com wss://*.walletconnect.com https://*.phantom.app https://*.helius-rpc.com wss://*.helius-rpc.com https://*.spline.design https://*.spline.cloud https://*.spline.app wss://*.spline.design wss://*.spline.cloud https://api.metaplex.com https://*.metaplex.com https://gateway.irys.xyz https://*.irys.xyz https://*.arweave.net;
