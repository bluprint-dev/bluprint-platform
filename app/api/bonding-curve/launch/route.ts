...
// Backend sadece transaction HAZIRLAR — imzalamaz, SOL harcamaz
// Kullanıcı cüzdanı imzalar → Genesis fee kullanıcıdan çekilir
// creatorFeeWallet = PLATFORM cüzdanı → her swap'ta fee buraya akar
export async function POST(req: NextRequest) {
  try {
    ...
    // Platform cüzdanı — swap fee'leri buraya akar
    ...
    const input = {
      wallet: userWallet,           // Kullanıcı cüzdanı — Genesis launch fee'yi O öder
      token: {
        name,
        symbol,
        image,                      // Direkt görsel URL (Pinata PNG/JPG)
    ...
    // createLaunch: sadece TX hazırlar, IMZALAMAZ
