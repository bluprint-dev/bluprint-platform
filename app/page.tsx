  ...
  return (
    <div style={{
      ...
      <section style={{ position: "relative", zIndex: 10, minHeight: "100vh", display: "flex", alignItems: "center" }}>
        <div className="hero-grid" style={{ maxWidth: 1280, margin: "0 auto", padding: "96px 24px", width: "100%", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}>
          ...
          <motion.div
            ...
            className="hero-logo-col" style={{ display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}
          >
          ...
          {tokens.length > 0 && (
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
              ...
              <div style={{ borderRadius: 18, padding: 24, background: "linear-gradient(135deg,rgba(153,69,255,0.08),rgba(10,4,16,0.98))" }}>
                ...
                <div className="koth-inner" style={{ display: "flex", alignItems: "center", gap: 24, flexWrap: "wrap" }}>
                  {tokens[0].imageUrl
