      ...
      <section style={{ position: "relative", zIndex: 10, minHeight: "100vh", display: "flex", alignItems: "center" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "96px 24px", width: "100%", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}>
          ...
          <motion.div initial={{ opacity: 0, x: -32 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.75, ease: [0.22,1,0.36,1] }}
            ...
            {/* badge */}
            <div style={{ display: "inline-flex", alignItems: "center", gap: 10, width: "fit-content", padding: "8px 16px", borderRadius: 999, background: "rgba(20,241,149,0.06)", border: "1px solid rgba(20,241,149,0.18)" }}>
            ...
            <div>
              ...
              <p style={{ marginTop: 24, marginBottom: 0, fontFamily: F.display, fontSize: 16, fontWeight: 400, lineHeight: 1.75, maxWidth: 480, color: "rgba(255,255,255,0.45)" }}>
            ...
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
              <Link href="/create" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "15px 32px", borderRadius: 14, background: "linear-gradient(135deg,#14F195,#0fa96a)", color: "#07070f", textDecoration: "none", fontFamily: F.display, fontSize: 14, fontWeight: 800, letterSpacing: "0.06em", boxShadow: "0 0 36px rgba(20,241,149,0.4),0 4px 20px rgba(20,241,149,0.2)" }}>
                ⬡ LAUNCH TOKEN · 0.15 SOL
              </Link>
              <Link href="/dex" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "15px 28px", borderRadius: 14, background: "rgba(153,69,255,0.08)", border: "1px solid rgba(153,69,255,0.32)", color: "rgba(153,69,255,0.9)", textDecoration: "none", fontFamily: F.display, fontSize: 13, fontWeight: 700, letterSpacing: "0.05em" }}>
                VIEW TERMINAL →
              </Link>
            </div>
            ...
            <div style={{ display: "flex", gap: 40, paddingTop: 8 }}>
              {[[tokens.length > 0 ? `${tokens.length}+` : "—", "TOKENS LIVE"], ["< 10s", "DEPLOY TIME"], ["100%", "ON-CHAIN"]].map(([v, l]) => (
                <div key={String(l)}>
                  <p style={{ margin: 0, fontFamily: F.display, fontSize: 30, fontWeight: 900, color: "#fff", letterSpacing: "-0.025em", lineHeight: 1 }}>{v}</p>
              ...
              <motion.div key="grid" initial={{ opacity: 0 }} animate={{ opacity: 1 }}
                ...
                {sorted.map((token, i) => (
                  <motion.div key={token.mint} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.05 }}
                    className="tc" style={{ borderRadius: 20, overflow: "hidden", cursor: "pointer", background: "linear-gradient(135deg,rgba(153,69,255,0.07),rgba(10,4,16,0.95))", border: "1px solid rgba(153,69,255,0.13)" }}>
